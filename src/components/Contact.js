...
const Contact = (props) => {
  return (
    <div className="flex items-center justify-center bg-contactContent">
      <div class="w-full  max-w-sm sm:max-w-lg mt-10 mb-10">
        <form
        ...
        >
          <div class="mb-4">
            <label class="block text-myColor text-sm font-bold mb-2" for="name">
              Name
            </label>
            <input
          ...
          <div className="flex items-center justify-end">
            <button
              className="flex items-center px-4 py-2 my-2 text-white rounded-md cursor-pointer group w-fit bg-myColor"
              type="submit"
            >
              Let's Talk
